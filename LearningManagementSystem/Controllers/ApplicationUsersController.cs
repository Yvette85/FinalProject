...
namespace LearningManagementSystem.Controllers
{
    public class ApplicationUsersController : Controller
    {
        ...
        public ActionResult AddStudent([Bind(Include = "Id,FirstName,LastName,Email,Password,ConfirmPassword,CourseId,UserName")] AddStudentViewModel applicationUser)
        {
